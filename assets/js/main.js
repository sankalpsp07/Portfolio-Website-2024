	...
	$(document).ready(function ($) {
  	...
  	/------------------------------------------------------*/
		...
		$(window).scroll(function () {
			...
			if (scroll > 300) {
				$(".vr-header-area.header-sticky").addClass("sticky");
				$(".vr-header-area.header-sticky").removeClass("sticky-out");
			} else if (scroll < lastScrollTop) {
				if (scroll < 500) {
					$(".vr-header-area.header-sticky").addClass("sticky-out");
					$(".vr-header-area.header-sticky").removeClass("sticky");
				}
			} else {
				$(".vr-header-area.header-sticky").removeClass("sticky");
			}
  	...
  	/------------------------------------------------------*/
		$(".vr-post__gallery.owl-carousel").owlCarousel({
			items: 1,
			loop: true,
			margin: 30,
			dots: false,
